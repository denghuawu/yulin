...
<!-- 初始隐藏 新建 -->
				<div id="content" class="hide">
					<form class="form-horizontal" action='index.php?r=job/create' method='post'>
						<div class="row">
							<!-- >	
							职位名称 -->
							<div class="control-group">
								...
								<div class="controls">
									<input name="Job[job_name]" type="text" data-rules="{required:true}" class="input-normal control-text"></div>
							</div>
						</div>
						<div class="row">
							<!-- 归属部门 -->	
							<div class="control-group">
								...
								<div class="controls">
									<select name="Job[depart_id]" class="input-normal">
						...
						<div class="row">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="Job[parent_id]" class="input-normal">
										<option value="">请选择</option>
