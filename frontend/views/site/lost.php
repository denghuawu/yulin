<div class="nav_top clearfix"><span class="re_left"></span>找回密码</div>
	<div class="wrap">
		<div class="register fs30 pb70">
			<form class="register_con" action='index.php?r=site/signup' method='post'>
				...
				<p><input type="password" placeholder='请输入新密码' name='User[password]' id='user-password'></p>
				...
				<p class="mt30"><input type="submit" value="提交"></p>
			</form>
		</div>
	</div>
